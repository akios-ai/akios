...
AKIOS is a **deliberately minimal, security-first containment layer** for AI agents in its early stage (v1.2.1).
...
## Current Contribution Stance (February 2026 – v1.2.1)
