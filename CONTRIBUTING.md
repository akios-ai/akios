...
AKIOS is a **deliberately minimal, security-first containment layer** for AI agents in its early stage (v1.5.0).
...
## Current Contribution Stance (March 2026 – v1.5.0)
...
| Type of contribution                  | Status in v1.5.0            | Process required                  |
|---------------------------------------|-----------------------------|------------------------------------|
