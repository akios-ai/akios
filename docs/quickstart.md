...
> **📦 Version Note:** `pip install akios` installs the latest stable version (currently v1.0.11). 
> For specific versions: `pip install akios==1.0.11`.
...
AKIOS v1.0.11 introduces the **Security Cage** — a controlled environment that activates all protections during workflow execution and destroys all data when deactivated.
