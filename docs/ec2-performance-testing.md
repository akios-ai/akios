...
**Date:** 2026-03-12  
**Scope:** AKIOS v1.4.4 native Linux performance & security validation on AWS EC2
...
**Based on AKIOS v1.4.4 validation on t4g.micro (ARM64, 1 GB RAM):**

```
Security Pipeline:  0.47 ms (full pipeline: PII + policy + audit + budget)
PII Scan:           0.46 ms (44 regex patterns)
...
# Verify installation
akios --version  # Should show "AKIOS 1.4.4"
```
