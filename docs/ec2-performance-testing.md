...
**Date:** 2026-01-30  
**Scope:** AKIOS v1.0.8 native Linux performance & security validation on AWS EC2
...
**Based on AKIOS v1.0.8 validation on t4g.micro (ARM64, 1 GB RAM):**
...
# Verify installation
akios --version  # Should show "AKIOS 1.0.8"
```
