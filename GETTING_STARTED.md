# 🚀 AKIOS v1.1.2 - Get Started in 3 Minutes
...
docker pull akiosai/akios:v1.1.2
...
# Run workflows
cd my-project
docker run --rm -v "$(pwd):/app" -w /app akiosai/akios:v1.1.2 run templates/hello-workflow.yml
```
...
*AKIOS v1.1.2 - Where AI meets unbreakable security* 🛡️🤖
