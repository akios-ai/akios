# 🚀 AKIOS v1.1.0 - Get Started in 3 Minutes
...
docker pull akiosai/akios:v1.1.0
...
# Run workflows
cd my-project
docker run --rm -v "$(pwd):/app" -w /app akiosai/akios:v1.1.0 run templates/hello-workflow.yml
```
...
*AKIOS v1.1.0 - Where AI meets unbreakable security* 🛡️🤖
